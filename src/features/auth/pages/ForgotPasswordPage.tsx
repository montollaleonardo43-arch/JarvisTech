    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-up">
        <div className="text-center mb-xl">
          ...
          <h1 className="text-h2 text-text-primary mb-sm">Recuperar contrasena</h1>
          <p className="text-text-secondary">Te enviaremos un enlace para restablecerla</p>
        </div>
        ...
        <div className="glass-strong rounded-2xl p-xl">
          {sent ? (
            <div className="text-center">
              ...
              <p className="text-text-primary text-body font-medium mb-sm">Revisa tu correo</p>
              <p className="text-text-secondary text-small">
                Si existe una cuenta con <span className="text-text-primary">{email}</span>, recibiras un
                enlace para restablecer tu contrasena.
              </p>
              <p className="text-text-tertiary text-caption mt-md">
                (Modo desarrollo: el enlace se muestra en la consola del backend)
              </p>
              <Link
                to="/login"
                className="inline-block mt-lg text-primary-300 hover:text-white text-small font-medium"
              >
